...
open class MappingPropertyChangeListener<I : Any, O : Any>(private val listener: PropertyChangeListener<O>, private val mapper: ValueUnwrapper<I, O>) : PropertyChangeListener<I> {
